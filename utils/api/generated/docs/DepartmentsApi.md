...
| [**viewAllMainDepartments**](#viewallmaindepartments)                                 | **GET** /department/view/main              | View All Main Departments                      |
| [**viewAllMainDepartments_0**](#viewallmaindepartments_0)                             | **GET** /department/view/main              | View All Main Departments                      |
| [**viewAllSubDepartments**](#viewallsubdepartments)                                   | **GET** /department/view/sub               | View All Sub-Departments                       |
| [**viewAllSubDepartments_0**](#viewallsubdepartments_0)                               | **GET** /department/view/sub               | View All Sub-Departments                       |
...
```typescript
import { DepartmentsApi, Configuration } from "./api";
...
const { status, data } =
  await apiInstance.getSubDepartmentsForSharedDepartment_0(key);
```
...
const { status, data } = await apiInstance.viewAllMainDepartments(limit, page);
```
